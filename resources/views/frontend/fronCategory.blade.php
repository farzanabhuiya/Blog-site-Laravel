                    ...
                    <div class="row gy-4">
                            ...
                            <div class="post post-grid rounded bordered">
                                ...
                                <div class="details">
                                    <ul class="meta list-inline mb-0">
                                        <li class="list-inline-item"><a href="category.html#"><img style="width: 50px;height:40px object-fit:cover;obect-position:center;" src="{{ asset('storage/users/'. $post->user->profile_img) }}" class="author" alt="author"/>{{$post->user->name}}</a></li>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="post post-grid rounded bordered">
                                ...
                                <div class="details">
                                    <ul class="meta list-inline mb-0">
                                        <li class="list-inline-item"><a href="category.html#"><img src="images/other/author-sm.png" class="author" alt="author"/>Katen Doe</a></li>
